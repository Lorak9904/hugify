...
INSTALLED_APPS = [
    'mental_api.apps.MentalApiConfig',
...
DATABASES = {
	'default': {
			...
			# 'HOST': 'localhost_settings_py',
			'HOST': config('DB_HOST'),
		}
}

database_url = os.environ.get('DATABASE_URL')
DATABASES['default'] = dj_database_url.parse('postgresql://hugify_user:jS66jHQnwjHfcY8ef0QsoyA2zjLVPsqG@dpg-ct0vpht6l47c73baevgg-a.frankfurt-postgres.render.com/hugify')
